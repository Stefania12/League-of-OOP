...
public class RogueStrategy extends Strategy {
    ...
    protected void executeLowerHp() {
        ...
        owner.changeHPBy(Math.round(Constants.ROGUE_STRATEGY_HP_GAIN_PERCENTAGE * owner.getHP()));
    }
    ...
    protected void executeMiddleHp() {
        ...
        owner.changeHPBy(-Math.round(Constants.ROGUE_STRATEGY_HP_LOSS_PERCENTAGE * owner.getHP()));
    }
}
