...
public final class Constants {
    ...
    public static final float FIREBLAST_ROGUE_MUTIPLIER = 0.8f;
    public static final float FIREBLAST_KNIGHT_MUTIPLIER = 1.2f;
    public static final float FIREBLAST_PYROMANCER_MUTIPLIER = 0.9f;
    public static final float FIREBLAST_WIZARD_MUTIPLIER = 1.05f;
    ...
    public static final float IGNITE_ROGUE_MUTIPLIER = 0.8f;
    public static final float IGNITE_KNIGHT_MUTIPLIER = 1.2f;
    public static final float IGNITE_PYROMANCER_MUTIPLIER = 0.9f;
    public static final float IGNITE_WIZARD_MUTIPLIER = 1.05f;
    ...
    public static final float SLAM_ROGUE_MUTIPLIER = 0.8f;
    public static final float SLAM_KNIGHT_MUTIPLIER = 1.2f;
    public static final float SLAM_PYROMANCER_MUTIPLIER = 0.9f;
    public static final float SLAM_WIZARD_MUTIPLIER = 1.05f;
    ...
    public static final float DRAIN_ROGUE_MUTIPLIER = 0.8f;
    public static final float DRAIN_KNIGHT_MUTIPLIER = 1.2f;
    public static final float DRAIN_PYROMANCER_MUTIPLIER = 0.9f;
    public static final float DRAIN_WIZARD_MUTIPLIER = 1.05f;
    ...
    public static final float DEFLECT_ROGUE_MUTIPLIER = 1.2f;
    public static final float DEFLECT_KNIGHT_MUTIPLIER = 1.4f;
    public static final float DEFLECT_PYROMANCER_MUTIPLIER = 1.3f;
    public static final float DEFLECT_WIZARD_MUTIPLIER = 0f;
    ...
    public static final float BACKSTAB_ROGUE_MUTIPLIER = 1.2f;
    public static final float BACKSTAB_KNIGHT_MUTIPLIER = 0.9f;
    public static final float BACKSTAB_PYROMANCER_MUTIPLIER = 1.25f;
    public static final float BACKSTAB_WIZARD_MUTIPLIER = 1.25f;
    ...
    public static final float PARALYSIS_ROGUE_MUTIPLIER = 0.9f;
    public static final float PARALYSIS_KNIGHT_MUTIPLIER = 0.8f;
    public static final float PARALYSIS_PYROMANCER_MUTIPLIER = 1.2f;
    public static final float PARALYSIS_WIZARD_MUTIPLIER = 1.25f;
}
